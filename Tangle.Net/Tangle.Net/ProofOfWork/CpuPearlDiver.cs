namespace Tangle.Net.ProofOfWork
{
  ...
  public class CpuPearlDiver : IPearlDiver
  {
    ...
    {
      this.Search(trits, minWeightMagnitude);
      return trits;
    }
    ...
    /// </param>
    private void Search(int[] transactionTrits, int minWeightMagnitude)
    {
      ...
      var numberOfThreads = Math.Max(Environment.ProcessorCount - 1, 1);
